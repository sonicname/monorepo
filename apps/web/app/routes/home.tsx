...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    {
      name: "description",
      content: "SSR React Router app connected to a NestJS API inside one pnpm workspace.",
    },
  ];
}
...
export default function Home({ loaderData }: Route.ComponentProps) {
  ...
  const statusLabel = loaderData.isHealthy ? "API reachable" : "API unavailable";
      ...
      <section className="status-grid">
        <div className="hero-card">
          ...
          <p className="hero-copy">
            This page is rendered by the React Router server and checks the Nest API during
            the route loader. It gives you a working end-to-end baseline for adding real data,
            auth, or shared packages next.
          </p>
            ...
            <article className="status-card">
              ...
              <div className="detail-list">
                <div className="detail-item">
                  ...
                  <span className="detail-value">React Router v7 framework mode with SSR</span>
                </div>
                <div className="detail-item">
                  <span className="detail-key">API app</span>
                  <span className="detail-value">NestJS on port 3001 with CORS enabled</span>
                </div>
              </div>
            </article>
        ...
        <div className="endpoint-card">
          ...
          <div className="detail-list">
            ...
            <div className="detail-item">
              ...
              <span className="detail-value">{loaderData.apiBaseUrl}/health</span>
            </div>
            <div className="detail-item">
              <span className="detail-key">Response status</span>
              <span className="detail-value">{loaderData.health?.status ?? "error"}</span>
            </div>
            <div className="detail-item">
              <span className="detail-key">Service name</span>
              <span className="detail-value">{loaderData.health?.name ?? "api"}</span>
            </div>
          </div>
